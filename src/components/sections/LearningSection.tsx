      ...
      <div className="section-padding">
        <div className="container-main">
          ...
          <motion.div className="mx-auto max-w-4xl rounded-2xl bg-white overflow-hidden"
            style={{ border: "1px solid rgba(58,174,206,0.18)", boxShadow: "0 12px 48px rgba(16,101,127,0.1)" }}
            ...
            <div className="flex items-center justify-between px-8 py-5"
              ...
              <div>
                <p className="text-[10px] font-bold tracking-[0.18em] uppercase text-[#3aaece]">Real campaign data</p>
              ...
              <svg viewBox="0 0 1020 248" className="w-full" style={{ overflow: "visible" }} aria-hidden="true">
                <defs>
                  ...
                  <linearGradient id="lgC2" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="rgba(58,174,206,0.22)" />
                    <stop offset="100%" stopColor="rgba(58,174,206,0.01)" />
                  </linearGradient>
                  <marker id="arrowTeal" markerWidth="9" markerHeight="7" refX="8" refY="3.5" orient="auto">
                    <polygon points="0 0, 9 3.5, 0 7" fill="#3aaece" />
                  </marker>
                  <filter id="cardShadow" x="-10%" y="-20%" width="120%" height="140%">
                    <feDropShadow dx="0" dy="2" stdDeviation="4" floodColor="rgba(16,101,127,0.12)" />
                  </filter>
                </defs>
                ...
                <motion.path
                  ...
                  fill="none" stroke="#3aaece" strokeWidth="2" strokeDasharray="5 4"
                ...
                <motion.rect x="418" y="112" width="164" height="52" rx="8"
                  fill="white" stroke="#3aaece" strokeWidth="1.5"
                ...
                <motion.text x="500" y="131" textAnchor="middle"
                  fontSize="11" fontWeight="800" fill="#3aaece" letterSpacing="0.1em"
                ...
                <motion.text x={BRACKET_X - 13} y={BMID + 13}
                  fontSize="10" fontWeight="600" fill="#3aaece"
                  textAnchor="end" fontFamily="Inter, system-ui, sans-serif"
                  initial={{ opacity: 0 }} animate={{ opacity: inView ? 1 : 0 }}
...
<text x={C2_X1} y={Y_BOT + 30} fontSize="11" fontWeight="700"
            ...
            <div className="flex items-center justify-between px-8 py-4"
              ...
              <span className="text-[11px] font-bold text-[#3aaece]">99% reduction in cost per acquisition</span>
            </div>
