...
const ses = new SESClient({ region: process.env.AWS_SES_REGION ?? "eu-west-2" });
    ...
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
        ...
        <tr><td style="background:#0d2535;border-radius:12px 12px 0 0;padding:32px 40px">
          <p style="margin:0;font-size:13px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:#3aaece">BroadLab</p>
        ...
        <tr><td style="background:#f9fafb;border-radius:0 0 12px 12px;padding:20px 40px;border-top:1px solid #e5e7eb">
          <p style="margin:0;font-size:12px;color:#9ca3af">Sent from broadlab.tv contact form · Reply directly to <a href="mailto:${email}" style="color:#3aaece">${email}</a></p>
        </td></tr>
